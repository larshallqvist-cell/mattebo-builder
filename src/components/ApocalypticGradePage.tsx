...
import { SuspenseResourceAccordion, SuspenseLessonCalendar, SuspenseMascotPanel } from "@/components/LazyComponents";
...
const TOOL_LINKS = [
  ...
  { label: "Tabellerna", url: "https://multiplication.fluentmath.com/" },
...
const ToolsGrid = ({
  ...
  heightClass: string;
  onChannelChange: (c: string | null) => void;
}) => (
        ...
        >
          ...
          >
            <div className={`max-w-7xl mx-auto ${forcedMobile ? "" : forcedDesktop ? "h-full" : "lg:h-full"}`}>
              ...
              <div
                className={`${forcedMobile ? "hidden" : forcedDesktop ? "grid grid-cols-12 [&>*:nth-child(1)]:col-span-5 [&>*:nth-child(2)]:col-span-4 [&>*:nth-child(3)]:col-span-3" : "hidden lg:grid lg:grid-cols-12"} gap-4 h-full`}
              >
                ...
                <div className="lg:col-span-4 flex flex-col gap-2 h-full min-h-0 overflow-y-auto industrial-scrollbar pr-1">
                  ...
                  <MetalPanel
                    ...
                    showSparks
                    titleExtra={activeRadioChannel && <Volume2 className="w-4 h-4 text-primary animate-pulse" />}
                  >
              ...
              <div
                className={`${forcedMobile || forcedDesktop ? "hidden" : "hidden md:grid md:grid-cols-2 lg:hidden"} gap-4 items-start pb-24`}
              >
              ...
              <div className={`${forcedMobile ? "" : forcedDesktop ? "hidden" : "md:hidden"} space-y-4 pb-24 px-1`}>
                ...
                <MetalPanel
                  ...
                  titleExtra={activeRadioChannel && <Volume2 className="w-5 h-5 text-primary animate-pulse" />}
                >
