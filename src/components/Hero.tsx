...
const Hero = ({
  ...
  return <section className={`relative w-full ${heightClass} flex items-center justify-center overflow-hidden`}>
      {/* Background image */}
      ...
      <div className="relative z-10 text-center px-4 mt-[10vh]">
        ...
        {subtitle && <p className="mt-2 text-lg md:text-xl text-muted-foreground">
            {subtitle}
          </p>}
      </div>
