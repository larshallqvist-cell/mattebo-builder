...
const LessonCalendar = ({
  ...
  return <div className="h-full flex flex-col bg-card rounded-lg border border-border overflow-hidden flex-1">
      ...
      <div className="flex-1 overflow-y-auto no-scrollbar">
        ...
        {error && <div className="p-8 text-center text-destructive">
            {error}
          </div>}
        ...
        return <div key={event.id}>
              {/* Week header */}
              {showWeekHeader && <div className="bg-muted px-4 py-2 border-b-2 border-chalk-yellow/60">
              ...
              <div className="px-3 py-2 border-b-2 hover:bg-muted/30 transition-colors border-[#fff1b3]">
                <div className="flex gap-3 items-center">
                  ...
                  <div className="flex-1 min-w-0 font-body">
                    ...
                    <div className="flex gap-2 text-base text-muted-foreground">
                      <span className="font-medium">{formatTime(event.date)}–{formatTime(event.endDate)}</span>
        ...
        {!loading && !error && upcomingEvents.length === 0 && <div className="p-8 text-center text-muted-foreground text-base">
