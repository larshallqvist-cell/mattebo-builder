...
const ApocalypticNav = () => {
  ...
  return <nav className="fixed top-0 left-0 right-0 z-50 px-6 py-4">
      <div className="max-w-5xl mx-auto flex items-center justify-between rounded-full px-6 py-[10px]" style={{
      ...
      border: "1px solid hsl(var(--primary) / 0.2)"
        ...
        <div className="flex items-center gap-5 text-sm font-nunito">
